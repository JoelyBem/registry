...
# Attention! This script contains a patch from https://github.com/andrey-pohilko/registry-cli/pull/113
# If the problem is solved then don't use this script. Use docker image anoxis/registry-cli
